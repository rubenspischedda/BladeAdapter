...
public abstract class BladeAdapter<T extends java.lang.Object> extends androidx.recyclerview.widget.RecyclerView.Adapter<androidx.recyclerview.widget.RecyclerView.ViewHolder> {
    ...
    private final java.lang.Object updateItemsInternal(java.util.List<? extends T> newItems, java.util.ArrayList<it.rubenspischedda.bladeadapter.BladeFilter<T>> newFilters, java.util.ArrayList<it.rubenspischedda.bladeadapter.BladeAttribute<?>> newAttributes, boolean newLoading, kotlin.jvm.functions.Function0<kotlin.Unit> onUpdateDone, kotlin.coroutines.Continuation<? super kotlin.Unit> continuation) {
        return null;
    }
    
    private final java.lang.Object applyDiffResult(java.util.List<? extends T> newItems, androidx.recyclerview.widget.DiffUtil.DiffResult diffResult, java.util.ArrayList<it.rubenspischedda.bladeadapter.BladeFilter<T>> newFilters, java.util.ArrayList<it.rubenspischedda.bladeadapter.BladeAttribute<?>> newAttributes, boolean newLoading, kotlin.jvm.functions.Function0<kotlin.Unit> onUpdateDone, kotlin.coroutines.Continuation<? super kotlin.Unit> continuation) {
        return null;
    }
    ...
    @org.jetbrains.annotations.Nullable()
    public abstract java.lang.Object calculateDiff(@org.jetbrains.annotations.NotNull()
    ...
    java.util.ArrayList<it.rubenspischedda.bladeadapter.BladeAttribute<?>> newAttributes, boolean oldLoading, boolean newLoading, @org.jetbrains.annotations.NotNull()
    kotlin.coroutines.Continuation<? super androidx.recyclerview.widget.DiffUtil.DiffResult> continuation);
